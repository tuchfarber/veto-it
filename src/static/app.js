window.onload = function() {
        ...
        methods: {
            ...
            removeMarker: function(id) {
                ...
                if (changed) {
                    ...
                    var veto_url = 'api/veto/' + sharedSession.sessionId + '/' + sharedSession.sessionKey;
    ...
    shareButton = new Vue({
        ...
        methods: {
            shareSession: function() {
                ...
                this.$http.post('api/create', session_data).then(
                    function(response) {
    ...
    sharedSession = new Vue({
        ...
        methods: {
            getData: function() {
                var retrieve_url = 'api/retrieve/' + sharedSession.sessionId + '/' + sharedSession.sessionKey;
